...
# Phase 2 waterfall test scene (same Phase 1 particles/router/solvers)
WATERFALL_CLIFF_Z = 2.15
WATERFALL_UPPER_Y = 2.25
WATERFALL_LOWER_Y = 0.05
WATERFALL_TRANSITION_WIDTH = 0.06
WATERFALL_CHANNEL_CENTER_X = 2.0
WATERFALL_CHANNEL_HALF_WIDTH = 0.9
WATERFALL_SOURCE_Z_MIN = 0.20
WATERFALL_SOURCE_Z_MAX = 1.35
WATERFALL_SOURCE_SPEED = 1.35
WATERFALL_WATER_DEPTH = 0.55
TERRAIN_COLLISION_RESTITUTION = 0.18
TERRAIN_TANGENTIAL_DAMPING = 0.992
