...
def main() -> None:
    ...
    parser.add_argument("--trajectory", type=Path, default=Path(__file__).resolve().parent / "datasets" / "debug" / "trajectory_000_single_cliff.npz")
    parser.add_argument("--output", type=Path, default=Path(__file__).resolve().parent / "checkpoints" / "debug_gnn.pt")
