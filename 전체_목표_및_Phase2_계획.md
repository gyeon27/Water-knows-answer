# Water-knows-answer — 전체 목표 및 Phase 2 계획
...
4. Phase 1에서 만든 `fluid_routing/solvers/splash_solver.py`를 기준(base) 솔버로 그대로 재사용할 수 있다.
...
| Phase 2 | 지형 조건부 강/폭포 파이프라인 + SPLASH 영역 GNN 학습 설계·구현 | **진행 중** |
| Phase 3 | Unreal Engine 통합 (스크린 공간 렌더링, 엔진 연동) | 예정 |
...
| P2-2d | rollout 학습 및 평가 | 예정 |
| P2-3 | Unreal inference/렌더링 연결 | 예정 |
